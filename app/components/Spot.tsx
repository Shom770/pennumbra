...
export default function Spot({
  ...
  const card = (
    <article className={`group relative h-full min-h-48 overflow-hidden rounded-2xl border ${submission ? "border-dashed border-[#ffd166]/65 bg-[#211744]/35 transition-[border-color,background-color,transform] hover:-translate-y-0.5 hover:border-[#ffd166] hover:bg-[#211744]/55" : "border-white/25 bg-[#211744]/45"} p-6 text-left backdrop-blur-sm`}>
      {image && (
        <div
      ...
      <span className="absolute right-5 -top-7 text-[clamp(96px,12vw,150px)] font-bold leading-none text-white/[.28] drop-shadow-[0_3px_16px_rgba(20,13,46,.45)] transition-colors group-hover:text-white/[.38] [font-family:var(--font-syne)]">
